...
typedef struct snapshot_context_s
{
    ...
    int fallback_to_streaming; /* 1 if snapshot failed and we should fallback to normal streaming */
    ...
    int idr_frame_started;     /* 1 if IDR frame detection confirmed, 0 if still probing */
