...
const base: TranslationDict = {
  ...
  audioTrackError: "The selected audio track could not be loaded. Video and the previous track will continue.",
  dismiss: "Dismiss",
  ...
  upstreamRequestFailedDescription:
    "The player could not load this stream from rtp2httpd. The server may be unavailable or have returned an unsuccessful HTTP response.",
  ...
  switchingAudioTrack: "Switching audio track",
...
const zhHans: TranslationDict = {
  ...
  audioTrackError: "无法加载所选音轨，视频和原音轨将继续播放。",
  dismiss: "关闭",
  mseNotSupported: "您的浏览器不支持 MSE (媒体源扩展)",
  failedToPlay: "播放失败",
  upstreamRequestFailed: "上游流请求失败",
  upstreamRequestFailedDescription: "播放器无法从 rtp2httpd 加载此视频流，服务端可能无法访问或返回了异常的 HTTP 响应。",
  httpStatus: "HTTP 状态",
  requestUrl: "请求地址",
...
const zhHant: TranslationDict = {
  ...
  audioTrackError: "無法載入所選音軌，影片和原音軌將繼續播放。",
  dismiss: "關閉",
  mseNotSupported: "您的瀏覽器不支援 MSE (媒體來源擴展)",
  failedToPlay: "播放失敗",
  upstreamRequestFailed: "上游串流請求失敗",
  upstreamRequestFailedDescription: "播放器無法從 rtp2httpd 載入此串流，服務端可能無法存取或返回了異常的 HTTP 回應。",
  httpStatus: "HTTP 狀態",
  requestUrl: "請求地址",
