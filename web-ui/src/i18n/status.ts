...
const base: TranslationDict = {
  ...
  maxClients: "Max allowed clients",
  ...
  clientStateHttpConnecting: "HTTP Connecting",
  clientStateHttpSendingRequest: "HTTP Sending Request",
  clientStateHttpAwaitingHeaders: "HTTP Awaiting Headers",
  clientStateHttpStreaming: "HTTP Streaming",
...
const zhHans: TranslationDict = {
  ...
  clientStateHttpConnecting: "HTTP 连接中",
  clientStateHttpSendingRequest: "HTTP 发送请求",
  clientStateHttpAwaitingHeaders: "HTTP 等待响应头",
  clientStateHttpStreaming: "HTTP 传输中",
...
const zhHant: TranslationDict = {
  ...
  clientStateFccMcastRequested: "FCC 組播已請求",
  clientStateFccMcastActive: "組播活躍",
  clientStateRtspInit: "RTSP 初始化",
  ...
  clientStateHttpConnecting: "HTTP 連線中",
  clientStateHttpSendingRequest: "HTTP 傳送請求",
  clientStateHttpAwaitingHeaders: "HTTP 等待回應標頭",
  clientStateHttpStreaming: "HTTP 傳輸中",
  clientStateDisconnected: "已斷線",
  clientStateUnknown: "未知狀態",
  clearLogs: "清空日誌",
  serviceControl: "服務控制",
  reloadConfig: "重載設定",
  restartWorkers: "重啟工作進程",
  reloading: "重載中…",
  restarting: "重啟中…",
  clearing: "清空中…",
};
