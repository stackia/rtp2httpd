export const PLAYER_OVERLAY_SURFACE_CLASS =
  "player-performance-overlay-background isolate overflow-hidden border border-blue-200/55 bg-slate-900/30 shadow-[0_18px_36px_-18px_rgba(0,0,0,0.82),0_0_28px_-12px_rgba(59,130,246,0.62),inset_0_1px_0_rgba(255,255,255,0.17),inset_0_-1px_0_rgba(59,130,246,0.14)] backdrop-blur-md backdrop-saturate-150";
...
export const PLAYER_SELECTED_GLASS_LAYER_CLASS =
  "player-performance-decoration pointer-events-none absolute inset-0 z-0 bg-[linear-gradient(135deg,rgba(147,197,253,0.18)_0%,rgba(59,130,246,0.13)_42%,rgba(99,102,241,0.2)_100%)] opacity-0 transition-opacity duration-300 ease-out motion-reduce:transition-none";

export const PLAYER_SELECTED_TOP_HIGHLIGHT_CLASS =
  "player-performance-decoration pointer-events-none absolute inset-x-3 top-0 z-20 h-px rounded-full bg-[linear-gradient(90deg,transparent_0%,rgba(147,197,253,0.42)_14%,rgba(219,234,254,0.96)_48%,rgba(165,180,252,0.68)_78%,transparent_100%)] opacity-0 shadow-[0_0_8px_rgba(147,197,253,0.46)] transition-opacity duration-300 ease-out motion-reduce:transition-none";

export const PLAYER_SELECTED_COMPACT_TOP_HIGHLIGHT_CLASS =
  "player-performance-decoration pointer-events-none absolute inset-x-1 top-px z-20 h-5 rounded-t-xl bg-[radial-gradient(ellipse_at_top,rgba(219,234,254,0.3)_0%,rgba(147,197,253,0.11)_42%,transparent_76%)] opacity-0 transition-opacity duration-300 ease-out motion-reduce:transition-none";
