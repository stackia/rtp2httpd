...
const base: TranslationDict = {
  ...
  sendTimeoutFlush: "Timeout flushes",
  poolTotal: "Total",
  poolFree: "Free",
  poolUsed: "Used",
  poolMax: "Max",
  ...
  clientStateFccMcastActive: "FCC Multicast Active",
...
const zhHans: TranslationDict = {
  ...
  clientStateFccUnicastPending: "FCC 单播等待",
  clientStateFccUnicastActive: "FCC 单播中",
  clientStateFccMcastRequested: "FCC 组播已请求",
  clientStateFccMcastActive: "组播中",
...
const zhHant: TranslationDict = {
  ...
  clientStateFccUnicastActive: "FCC 單播中",
  clientStateFccMcastRequested: "FCC 多播已請求",
  clientStateFccMcastActive: "多播中",
  clientStateRtspInit: "RTSP 初始化",
